...
const PasswordGenerator = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0d1117] flex items-start justify-center p-6 sm:p-10">
      <div className="bg-[#161b22] rounded-xl shadow-lg w-full max-w-3xl p-6 sm:p-10 border border-[#30363d] space-y-8">
        {/* Header */}
        <div>
        ...
        <div className="relative">
          <input
            ...
            value={password}
            readOnly
            className="w-full bg-[#0d1117] text-[#c9d1d9] rounded-lg p-3 sm:p-4 pr-12 font-mono text-lg border border-[#30363d] focus:outline-none focus:ring-2 focus:ring-[#58a6ff]"
          />
          <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            ...
            <label
              key={idx}
              className="flex items-center justify-between p-3 sm:p-4 bg-[#0d1117] rounded-lg border border-[#30363d] cursor-pointer hover:bg-[#21262d]"
            >
        ...
        <button
          ...
          className="w-full bg-[#238636] hover:bg-[#2ea043] text-white font-semibold py-3 sm:py-4 rounded-lg flex items-center justify-center gap-2 transition disabled:opacity-50 disabled:cursor-not-allowed"
        >
