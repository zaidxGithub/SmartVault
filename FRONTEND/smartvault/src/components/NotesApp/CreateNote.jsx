...
const CreateNote = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0d1117] p-4 sm:p-6">
      ...
      <div className="max-w-3xl mx-auto bg-[#161b22] rounded-xl shadow-lg border border-[#30363d] overflow-hidden">
        {/* Header */}
        <div className="px-6 py-4 border-b border-[#30363d]">
          <h2 className="text-xl sm:text-2xl font-bold text-[#c9d1d9] tracking-wide">
            New Note
          </h2>
        </div>
        ...
        <div className="px-6 py-6 space-y-8">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-[#0d1117] border border-[#30363d] rounded-md 
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full px-4 py-2 bg-[#0d1117] border border-[#30363d] rounded-md 
              focus:ring-2 focus:ring-[#58a6ff] focus:border-[#58a6ff] outline-none 
              transition text-[#c9d1d9] placeholder-[#8b949e] min-h-[160px] sm:min-h-[200px] 
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-[#30363d]">
            <button
              onClick={() => navigate("/noteshome")}
              className="px-5 py-2 border border-[#30363d] bg-[#21262d] text-[#c9d1d9] 
              rounded-md hover:bg-[#30363d] focus:ring-2 focus:ring-[#58a6ff] 
            ...
            <button
              onClick={createNote}
              className="px-5 py-2 bg-[#238636] text-white rounded-md 
              hover:bg-[#2ea043] focus:ring-2 focus:ring-[#2ea043] 
              focus:ring-offset-2 focus:ring-offset-[#0d1117] transition text-sm sm:text-base"
            >
              Save
            </button>
