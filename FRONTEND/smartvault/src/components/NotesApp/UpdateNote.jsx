        ...
        <div className="p-4 sm:p-6 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <input
              ...
              className="w-full px-3 py-2 sm:px-4 sm:py-2 bg-[#0d1117] border border-[#30363d] rounded-md 
                         focus:ring-2 focus:ring-[#58a6ff] focus:border-[#58a6ff] outline-none 
                         text-[#c9d1d9] placeholder-[#8b949e] text-sm sm:text-base"
            />
            <div className="text-xs sm:text-sm">
              {title === "" ? (
                <p className="text-[#f85149]">⚠️ Title required</p>
              ) : (
          ...
          <div className="space-y-3">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 sm:px-4 sm:py-2 bg-[#0d1117] border border-[#30363d] rounded-md 
                         focus:ring-2 focus:ring-[#58a6ff] focus:border-[#58a6ff] outline-none 
                         text-[#c9d1d9] placeholder-[#8b949e] min-h-[150px] sm:min-h-[200px] resize-y 
                         text-sm sm:text-base"
            ></textarea>
            <div className="text-xs sm:text-sm">
              {content === "" ? (
                <p className="text-[#f85149]">⚠️ Content required</p>
              ) : (
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-3 pt-4 border-t border-[#30363d]">
            <button
              ...
              className="w-full sm:w-auto px-5 py-2 border border-[#30363d] bg-[#21262d] 
                         text-[#c9d1d9] rounded-md hover:bg-[#30363d] 
                         focus:ring-2 focus:ring-[#58a6ff] focus:ring-offset-2 
                         focus:ring-offset-[#0d1117] transition"
            >
              Cancel
            </button>
            <button
              onClick={handleUpdate}
              className="w-full sm:w-auto px-5 py-2 bg-[#238636] text-white rounded-md 
